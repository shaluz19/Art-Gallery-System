...
&nbsp; in your cart.&nbsp;
            <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="True" NavigateUrl="~/UserHome.aspx">Continue Shopping</asp:HyperLink>
            <br />
            <br />
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" Height="243px" OnRowDeleting="GridView1_RowDeleting"  ShowFooter="True" Width="430px">
            <Columns>
        ...
        <p>
            &nbsp;</p>
        <asp:Button ID="Button02" runat="server" BackColor="#FF3300" OnClick="Button1_Click" Text="Checkout" />
          <!---Footer COntents End---->
                 <!-- Start Footer  -->
    <footer>
