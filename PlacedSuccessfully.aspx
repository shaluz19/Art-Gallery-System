...
<body>
    ...
    <!-- End All Title Box -->
        <asp:Label ID="Label1" runat="server" Text="Your Product has been successfully placed.Thanks"></asp:Label>
        .<asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/UserHome.aspx">Continue Shopping</asp:HyperLink>
         <!-- Start Footer  -->
    <footer>
